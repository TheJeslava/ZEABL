...
VERSION_NAME="$(basename "$ROOT_DIR")"
OUTPUT_PATH="${OUTPUT_PATH:-results/zoomearth-${VERSION_NAME}-reference-150.jsonl}"
METRICS_PATH="${METRICS_PATH:-results/zoomearth-${VERSION_NAME}-reference-150.metrics.json}"
POSITIONS="$(seq -s, 250 299),$(seq -s, 350 399),$(seq -s, 550 599)"
