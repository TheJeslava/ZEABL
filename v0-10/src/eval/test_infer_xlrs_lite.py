...
class InferXLRSAdapterTests(unittest.TestCase):
    ...
    def test_reference_crop_prompt_uses_exact_v03_middle_instruction(self):
        sample = self.sample(self.FOUR_CHOICE_CATEGORY)
        question_prompt = "crop-local question and choices"

        prompt = make_reference_stage2_prompt(question_prompt, sample)
