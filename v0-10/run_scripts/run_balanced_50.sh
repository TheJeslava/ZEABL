...
METRICS_PATH="${METRICS_PATH:-results/zoomearth-xlrs-balanced-50.metrics.json}"
SELECTION_PATH="${SELECTION_PATH:-results/zoomearth-xlrs-balanced-50.selection.json}"
